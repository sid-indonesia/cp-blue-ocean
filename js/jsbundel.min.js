...
(function ($) {
  ...
  if ($.fn.owlCarousel) {
      $(".summit-service-slides").owlCarousel({
          items: 3,
          loop: true,
          autoplay: true,
          smartSpeed: 800,
  ...
  if ($.fn.owlCarousel) {
      $(".summit-workflow-slides").owlCarousel({
          items: 3,
          loop: true,
          autoplay: true,
          smartSpeed: 800,
  ...
  if ($.fn.owlCarousel) {
      $(".summit-team-slides").owlCarousel({
          items: 3,
          loop: true,
          autoplay: true,
          smartSpeed: 800,
  ...
  if ($.fn.imagesLoaded) {
      $('.summit-portfolio').imagesLoaded(function () {
          ...
          // init Isotope
          var $grid = $('.summit-portfolio').isotope({
